...
function CommandPalette({ isOpen, onClose, onCommand }) {
  ...
  const commands = [
    ...
    { id: 'ai.generateCode', title: 'AI: Generate Code', category: 'AI Assistant' },
    { id: 'ai.explainCode', title: 'AI: Explain Code', category: 'AI Assistant' },
    { id: 'ai.fixBug', title: 'AI: Fix Bug', category: 'AI Assistant' },
